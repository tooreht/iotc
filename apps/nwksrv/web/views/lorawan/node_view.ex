defmodule NwkSrv.LoRaWAN.NodeView do
  use NwkSrv.Web, :view

  def render("index.json", %{lorawan_nodes: lorawan_nodes}) do
    %{data: render_many(lorawan_nodes, NwkSrv.LoRaWAN.NodeView, "node.json")}
  end

  def render("show.json", %{node: node}) do
    %{data: render_one(node, NwkSrv.LoRaWAN.NodeView, "node.json")}
  end
