...
Core.Storage.LoRaWAN.Node.create(%{rev_dev_eui: <<70, 161, 210, 121, 0, 0, 0, 0>>, rev_dev_addr: <<70, 161, 210, 121>>, rev_nwk_s_key: <<131, 132, 1, 172, 17, 228, 225, 223, 76, 106, 213, 106, 7, 71, 210, 196>>, application_id: allo_application_id, user_id: user_id})
Core.Storage.LoRaWAN.Node.create(%{rev_dev_eui: <<232, 234, 74, 5, 0, 0, 0, 0>>, rev_dev_addr: <<232, 234, 74, 5>>, rev_nwk_s_key: <<161, 42, 191, 172, 19, 233, 95, 48, 212, 181, 23, 190, 178, 90, 57, 122>>, application_id: tresh_application_id, user_id: user_id})
Core.Storage.LoRaWAN.Node.create(%{rev_dev_eui: <<139, 119, 102, 95, 78, 61, 43, 42>>, rev_dev_addr: <<1, 0, 0, 0>>, rev_nwk_s_key: <<17, 30, 241, 28, 88, 191, 249, 198, 210, 135, 184, 116, 102, 146, 64, 223>>, application_id: allo_application_id, user_id: user_id})
Core.Storage.LoRaWAN.Node.create(%{rev_dev_eui: <<138, 119, 102, 95, 78, 61, 43, 42>>, rev_dev_addr: <<2, 0, 0, 0>>, rev_nwk_s_key: <<98, 122, 185, 83, 49, 33, 35, 132, 193, 203, 116, 81, 74, 14, 201, 84>>, application_id: allo_application_id, user_id: user_id})
